...
class ListFilesForOwnerQuery:
    ...
    def execute(self, owner_id: str, kind: Optional[FileKind], limit: Optional[int]) -> List[FileResponse]:
...
class ListFilesForBookQuery:
    ...
    def execute(self, book_id: str, kind: Optional[FileKind], limit: Optional[int]) -> List[FileResponse]:
